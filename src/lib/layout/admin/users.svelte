<script lang="ts">
  ...
  export const supabase = createClient(
    "https://kqxvsqijncznqwmffevd.supabase.co",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtxeHZzcWlqbmN6bnF3bWZmZXZkIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTc5MDE3NDQsImV4cCI6MjAxMzQ3Nzc0NH0.wrGcEJ20jJQOtssRm73CuNPWhAsx11j63XNxtvO3D1E"
  );
  import {
    ListBox,
    ListBoxItem,
...
<div class="h-10vh card p-8 mb-4 flex flex-row gap-8">
  ...
  {/if}
  {#if selectedMembers.length >= 1}
    <a class="cursor-pointer" on:click={confirmDeleteUser}>
      <svg
